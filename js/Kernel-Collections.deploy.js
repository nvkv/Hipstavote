...
fn: function (aBlock) {
    ...
    try {
        ...
        if (e.name === "stReturn" && e.selector === "_lineIndicesDo_") {
            return e.fn();
        }
        throw e;
    }
...
fn: function (anIndex) {
    ...
    try {
        ...
        if (e.name === "stReturn" && e.selector === "_lineNumber_") {
            return e.fn();
        }
        throw e;
    }
...
fn: function (aSymbol) {
    var self = this;
    try {
        ($receiver = smalltalk.send(smalltalk.send(aSymbol, "_class", []), "__eq", [smalltalk.send(self, "_class", [])])).klass === smalltalk.Boolean ? !$receiver ? function () {return function () {throw {name: "stReturn", selector: "__eq", fn: function () {return false;}};}();}() : nil : smalltalk.send($receiver, "_ifFalse_", [function () {return function () {throw {name: "stReturn", selector: "__eq", fn: function () {return false;}};}();}]);
...
fn: function (aKey, aBlock) {
    var self = this;
    return ($receiver = smalltalk.send(self, "_basicAt_", [aKey])) != nil &&
        $receiver != undefined ? function () {return smalltalk.send(aBlock, "_value_", [smalltalk.send(self, "_at_", [aKey])]);}() : nil;
    return self;
}
}),
smalltalk.HashedCollection);
...
fn: function (aHashedCollection) {
    var self = this;
    try {
        ($receiver = smalltalk.send(smalltalk.send(self, "_class", []), "__eq", [smalltalk.send(aHashedCollection, "_class", [])])).klass === smalltalk.Boolean ? !$receiver ? function () {return function () {throw {name: "stReturn", selector: "__eq", fn: function () {return false;}};}();}() : nil : smalltalk.send($receiver, "_ifFalse_", [function () {return function () {throw {name: "stReturn", selector: "__eq", fn: function () {return false;}};}();}]);
